	<h2 style="text-align : center">Cerca un parcheggio</h2>
	<br />
{ if $step }
	<ul>
	{ foreach from=$parcheggi_array key=id item=nome }
		<li><a href="index.php?action=mostra_parcheggio&parcheggio_id={ $id }">{ $nome }</a></li>
	{ /foreach }
	</ul>
{ else }
	<form action="index.php?action=cerca_parcheggio" method="post">
